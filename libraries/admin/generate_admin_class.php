...
Utils::load_libraries(array('utilities/menu_barr_hierarchy', 'simplelist', 'generate_admin_ng'));
		...
		if(isset(Webmodel::$model[$model_name]))
		{
			...
			switch($_GET['op_update'])
			{
				...
				default:
					...
					echo View::load_view(array(Webmodel::$model[$model_name]->forms, $arr_fields, $url_post, Webmodel::$model[$model_name]->enctype, '_generate_admin_'.$model_name, $this->arr_categories), 'common/forms/updatemodelform');

					$cont_index=ob_get_contents();

					ob_end_clean();

					echo View::load_view(array(I18n::lang('common', 'edit', 'Edit'), $cont_index), 'content');
...
class ListModelClass {
	...
	public function show()
	{
		...
		case 1:
			...
			echo View::load_view(array(Webmodel::$model[$this->model_name]->forms, $this->arr_fields_form, $this->url_options, Webmodel::$model[$this->model_name]->enctype, '_generate_admin_'.$this->model_name), 'common/forms/updatemodelform');
...
class SearchFormClass {
	...
	public function search_form()
	{
		...
		echo View::load_view(array($this->arr_search_field, $this->arr_order_field, $this->arr_order_select, $this->url_options), 'common/forms/searchform');
...
class ListModelAjaxClass {
	...
	function show()
	{
		...
		echo View::load_view(array($query, $this), 'utilities/list');
