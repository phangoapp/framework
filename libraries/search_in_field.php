...
/**
* A function for create a where statement for mysql.
*/
...
function search_in_field($model_name, $fields, $phrase_search)
{
	...
	if($c<31 && $phrase_search!='')
	{
		...
		foreach($fields as $field)
		{
			...
			//$check_phrase_search=PhangoVar::$model[$model_name]->forms[$field]->type->check($phrase_search);
		...
		/*if(isset(PhangoVar::$model[$model_name]->components[$field]->related_model))
		{
